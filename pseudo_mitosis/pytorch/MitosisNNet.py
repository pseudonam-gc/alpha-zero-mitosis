...
class MitosisNNet(nn.Module):
    def __init__(self, game, args):
        ...
        #self.conv1 = nn.Linear(self.input_size, args.num_channels)
        #self.conv2 = nn.Linear(args.num_channels, args.num_channels)
        #self.conv3 = nn.Linear(args.num_channels, args.num_channels)
    ...
    def forward(self, s):
        ...
        s = F.relu(self.conv1(s, self.edge_index))  # Apply batch normalization and ReLU activation
        s = F.relu(self.conv2(s, self.edge_index))
        s = F.relu(self.conv3(s, self.edge_index))
